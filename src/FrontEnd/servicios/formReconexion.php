...
<section class="container section white">
    ...
    <div class="row col s12">
        <div class="center waves-color-demo ">
                ...
                <div class="row" >
                    <div class="input-field col s6">
                        <select class="browser-default" name="tipoServicio" onchange="location = this.value" required="">
                            ...
                            <option value="formReconexion.php" selected>Reconexiones fuera de gestion</option>
                        </select>
                    </div>
                </div>
            ...
            <form action="_indexServicioBean.php" id="reconexionForm" method="post">
                <div class="row">
                ...
                <table class="striped centered responsive-table">
                    ...
                    <tbody>
                    <tr>
                        <input type="hidden" value="RECONEXION" class="validate center">
                        <td>
                        ...
                        <td>
                            <input required name="osCorte" placeholder="osCorte" type="text" class="validate center">
                        </td>
                        <td>
                            <input required name="lecturaInicial" placeholder="lecturaInicial" type="text" class="validate center">
                        </td>
