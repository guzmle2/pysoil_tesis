...
<section class="container section white">
    ...
    <div class="row col s12">
        <div class="center waves-color-demo ">
                ...
                <div class="row" >
                    <div class="input-field col s6">
                        <select class="browser-default" name="tipoServicio" onchange="location = this.value" required="">
                            ...
                            <option value="formSellado.php" selected>Sellado</option>
            ...
            <form action="_indexServicioBean.php" id="selladoForm" method="post">
                <div class="row">
                ...
                <table class="striped centered responsive-table">
                    ...
                    <tbody>
                    <tr>
                        <input name="tipoServicio" type="hidden" value="SELLADO" class="validate center">
