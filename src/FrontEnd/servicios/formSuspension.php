...
<section class="container section white">
    ...
    <div class="row col s12">
        <div class="center waves-color-demo ">
                ...
                <div class="row" >
                    <div class="input-field col s6">
                        <select class="browser-default" name="tipoServicio" onchange="location = this.value" required="">
                            <option value="formSuspension.php" selected>Suspension</option>
            ...
            <form action="_indexServicioBean.php" id="suspensionForm" method="POST">
                <div class="row">
                ...
                <table class="striped centered responsive-table">
                    ...
                    <tbody>
                    <tr>
                        <input required name="tipoServicio" type="hidden" class="validate center" value="SUSPENSION">
                        <td>
                        ...
                        <td>
                            <input required name="osReconexion" placeholder="os/Reconexion" type="text" class="validate center">
                        </td>

                        <td>
                            <input required name="lecturaFinal" placeholder="Lectura Final" type="text" class="validate center">
                        </td>

                        <td>
                            <input type="date" class="datepicker" name="fechaReconexion" placeholder="fecha_reconexion" required="">
                        </td>
